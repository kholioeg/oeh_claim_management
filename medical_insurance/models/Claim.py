...
class Visit(models.Model):
    ...
    contribution_charge = fields.Float(string='Contribution Charge', related='service_line_id.vendor_price', readonly=True, store='True', groups='medical_insurance.group_account')
